                ...
                <div class="col-lg-12">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                                    ...
                                    <span>With a remarkable track record in <b>complex spinal surgeries</b>, Dr. Vishal Kundnani has emerged as a leader in <b>robotic and minimally invasive spine procedures.</b> His ability to handle the most challenging spine disorders with <b>exceptional precision and care</b> has earned him widespread acclaim. Patients trust him not only for his <b>surgical expertise</b> but also for his <b>compassionate approach</b>, ensuring that each individual receives the <b>highest standard of care</b> tailored to their unique condition.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="member">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-3 col-md-3 col-12">  
                                <div class="doctor-pic">
                                    <img src="img/dr-sameer-dalvie.jpg" alt="" class="img-responsive">
                                </div> 
                            </div>
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                                    <h2>Dr. Sameer Dalvie (Mumbai)</h2>
                                    <span>A well-respected spine surgeon in Mumbai, Dr. Dalvie specializes in spinal trauma, degenerative diseases, and minimally invasive surgeries. His meticulous approach ensures better post-operative recovery with minimal discomfort for his patients.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-3 col-md-3 col-12">  
                                <div class="doctor-pic">
                                    <img src="img/dr-arvind-kulkarni.jpg" alt="" class="img-responsive">
                                </div> 
                            </div>
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                                    <h2>Dr. Arvind Kulkarni (Mumbai)</h2>
                                    <span>Known for his expertise in spinal deformities and trauma, Dr. Kulkarni is a trusted name in the field of spine surgery. His skills in both traditional and minimally invasive techniques make him highly sought after.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                                    ...
                                    <span>A leading spine surgeon at Jaslok Hospital, Dr. Nene is recognized for his work in spinal deformities and trauma. His commitment to surgical precision and post-operative care ensures excellent patient outcomes.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-3 col-md-3 col-12">  
                                <div class="doctor-pic">
                                    <img src="img/dr-sumit-sinha.jpg" alt="" class="img-responsive">
                                </div> 
                            </div>
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                    ...
                    <div class="member">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-3 col-md-3 col-12">  
                                <div class="doctor-pic">
                                    <img src="img/dr-balamurali.jpg" alt="" class="img-responsive">
                                </div> 
                            </div>
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                                    <h2>Dr. Balamurali (Chennai)</h2>
                                    <span>An expert in scoliosis and spinal deformity correction, Dr. Balamurali has transformed the lives of many patients through his advanced surgical techniques and personalized care approach.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-3 col-md-3 col-12">  
                                <div class="doctor-pic">
                                    <img src="img/dr-sajan-hegde.jpg" alt="" class="img-responsive">
                                </div> 
                            </div>
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                                    <h2>Dr. Sajan Hegde (Chennai)</h2>
                                    <span>A renowned spine specialist, Dr. Hegde is known for his proficiency in minimally invasive surgery and spinal reconstruction, ensuring safe and effective treatments for a variety of spine disorders.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-3 col-md-3 col-12">  
                                <div class="doctor-pic">
                                    <img src="img/dr-harsh-hegde.jpg" alt="" class="img-responsive">
                                </div> 
                            </div>
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                    ...
                    <div class="member">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-3 col-md-3 col-12">  
                                <div class="doctor-pic">
                                    <img src="img/dr-h-s-chhabra.jpg" alt="" class="img-responsive">
                                </div> 
                            </div>
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
                                    <h2>Dr. H.S. Chhabra (Delhi)</h2>
                                    <span>With extensive experience in spinal injuries and rehabilitation, Dr. Chhabra is a leader in complex spine surgery and post-surgical recovery programs.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="member">
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-3 col-md-3 col-12">  
                                <div class="doctor-pic">
                                    <img src="img/dr-thomas-kishen.jpg" alt="" class="img-responsive">
                                </div> 
                            </div>
                            <div class="col-lg-9 col-md-9 col-12">
                                <div class="member-info member-info1 mt-lg-0 mt-md-0 mt-4">
