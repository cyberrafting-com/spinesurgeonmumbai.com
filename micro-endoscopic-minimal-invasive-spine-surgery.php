...
<head>
    ...
    <title>Micro Endoscopic Minimal Invasive Spine Surgery in Mumbai</title>    
<meta name="description" content="Discover micro endoscopic minimal invasive spine surgery with Dr. Vishal Kundnani Spine Surgeon in Mumbai. Advanced treatments for spine issues in Mumbai.">  
		...
		<div class="container">
			<div class="row">
				...
				<ul class="breadcrumb1">
					...
					<li><a href="micro-endoscopic-minimal-invasive-spine-surgery.php">Micro Endoscopic Minimal Invasive Spine Surgery</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="cliclskil1 mt-3">
			...
			<div class="container ba_image mt-4">
				...
				<div class="cliclskil1 mt-2">
					...
					<p class="mt-2"><b>Micro Endoscopic Minimal Invasive Spine Surgery or Minimal Invasive Spine Surgery Gallery –</b></p>	<ul class="mt-1">
