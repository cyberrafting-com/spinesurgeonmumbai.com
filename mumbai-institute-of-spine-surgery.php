		...
		<div class="container">
			<div class="row">
				...
				<ul class="breadcrumb1">
					...
					<li><a href="mumbai-institute-of-spine-surgery.php">Mumbai Institute of Spine Surgery</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="gallery-area pt-100 pb-75">
			<div class="container">
				...
				<div class="col-lg-4 col-md-4">
						...
						<div class="col-lg-4 col-md-4">
						<div class="single-gallery-item">
							<a data-fancybox="gallery" href="img/gallery/d/5.jpg">
								<img src="img/gallery/d/5.jpg" alt="" class="gal-img">
							</a>
							<div class="icon">
								<!-- <a data-fancybox="gallery" href="img/gallery/d/1.jpg">
                                    <i class="ri-loader-fill"></i>
						...
						<div class="col-lg-4 col-md-4">
						<div class="single-gallery-item">
							<a data-fancybox="gallery" href="img/gallery/d/7.jpg">
								<img src="img/gallery/d/7.jpg" alt="" class="gal-img">
							</a>
							<div class="icon">
								<!-- <a data-fancybox="gallery" href="img/gallery/d/1.jpg">
                                    <i class="ri-loader-fill"></i>
					...
					<div class="col-lg-4 col-md-4">
						<div class="single-gallery-item">
							<a data-fancybox="gallery" href="img/gallery/d/1.jpg">
								<img src="img/gallery/d/1.jpg" alt="" class="gal-img">
							</a>
							<div class="icon">
								<!-- <a data-fancybox="gallery" href="img/gallery/d/1.jpg">
                                    <i class="ri-loader-fill"></i>
					...
					<div class="col-lg-4 col-md-4">
						<div class="single-gallery-item">
							<a data-fancybox="gallery" href="img/gallery/d/2.jpg">
								<img src="img/gallery/d/2.jpg" alt="" class="gal-img">
							</a>
							<div class="icon">
							<!-- <a data-fancybox="gallery" href="img/gallery/d/1.jpg">
                                    <i class="ri-loader-fill"></i>
					...
					<div class="col-lg-4 col-md-4">
						<div class="single-gallery-item">
							<a data-fancybox="gallery" href="img/gallery/d/6.jpg">
								<img src="img/gallery/d/6.jpg" alt="" class="gal-img">
							</a>
							<div class="icon">
								<!-- <a data-fancybox="gallery" href="img/gallery/d/1.jpg">
                                    <i class="ri-loader-fill"></i>
					...
					<div class="col-lg-4 col-md-4">
						<div class="single-gallery-item">
							<a data-fancybox="gallery" href="img/gallery/d/8.jpg">
								<img src="img/gallery/d/8.jpg" alt="" class="gal-img">
							</a>
							<div class="icon">
								<!-- <a data-fancybox="gallery" href="img/gallery/d/1.jpg">
                                    <i class="ri-loader-fill"></i>
					...
					<div class="col-lg-4 col-md-4">
						<div class="single-gallery-item">
							<a data-fancybox="gallery" href="img/gallery/d/9.jpg">
								<img src="img/gallery/d/9.jpg" alt="" class="gal-img">
							</a>
							<div class="icon">
								<!-- <a data-fancybox="gallery" href="img/gallery/d/1.jpg">
                                    <i class="ri-loader-fill"></i>
