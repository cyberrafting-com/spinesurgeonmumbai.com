                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="language-buttons">
                                    <a href="{{ route('what-is-sciatica-and-why-it-happens') }}" class="language-btn {{ request()->is('sciatica') && !request()->is('sciatica-*') ? 'active' : '' }}">अंग्रेज़ी</a>
                                    <a href="{{ route('sciatica-h') }}" class="language-btn {{ request()->is('sciatica-h') ? 'active' : '' }}">हिंदी</a>
                                    <a href="{{ route('sciatica-m') }}" class="language-btn {{ request()->is('sciatica-m') ? 'active' : '' }}">मराठी</a>
                                </div>
                            </div>
                        </div>
                    </div>
