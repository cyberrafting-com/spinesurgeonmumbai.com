@php($title = 'Best Scoliosis Surgery in India | Dr. Vishal Kundnani, Mumbai')

@section('meta_desc')Top scoliosis surgeon in Mumbai, Dr. Vishal Kundnani offers robotic & navigation-guided spine
surgery for adolescent, congenital & adult spinal deformities.@endsection
                ...
                <div class="blog-profile-details">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-12">
                            ...
                            <p><a href="scoliosis.php"><strong>Scoliosis</strong></a>, a spinal deformity that causes
                    ...
                    <div class="sec-blog-design pt-5">
                        ...
                        <p>With over 7,000 successful spine surgeries, including advanced spinal deformity
                            corrections, <a href="{{ route('about-doctor') }}">Dr. Vishal Kundnani</a> is trusted for safe,
                    ...
                    <div class="sec-blog-design pt-5">
                        <p>If you're searching for the <strong>best scoliosis surgery in India</strong> or
                            looking for a trusted <strong>scoliosis specialist in Mumbai</strong>, Dr. Vishal Kundnani
                            offers
