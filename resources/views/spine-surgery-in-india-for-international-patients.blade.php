@php($title = 'Robotic Spine Surgery in Mumbai | Dr. Vishal Kundnani')

@section('meta_desc')Discover advanced robotic spine surgery in Mumbai with Dr. Vishal Kundnani. Precise, minimally
invasive treatment with faster recovery & global expertise.@endsection
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                <div class="blog-profile-details">
                    <div class="sec-blog-design pt-5">
                        ...
                        <img src="{{ asset('resources/assets/img/blog/SPINE-SURGERY-in-india-for-international-patients.jpg') }}">
                    </div>
