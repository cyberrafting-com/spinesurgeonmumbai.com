@php($title = 'Minimal Invasive spine surgery: Spine Surgery Treatment in Mumbai')

@section('meta_desc')Explore minimal invasive spine surgery options with Dr. Vishal Kundnani Spine Surgeon in Mumbai. Advanced treatments for spine issues in Mumbai.@endsection
    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="breadcrumb1">
                ...
                <li><a href="{{ route('minimal-invasive-spine-surgery') }}">Minimal Invasive Spine Surgery – General</a></li>
            </ul>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="cliclskil1 mt-2">
                        ...
                        <div class="bordered-section">
                            ...
                            <br>
                            <p>At <a href="{{ route('home') }}" target="_blank"><strong>Spine
                                        Clinic Mumbai</strong></a>, led by <a
                                    href="{{ route('about-doctor') }}" target="_blank">Dr.
                            ...
                            <p>If you are seeking safe and effective solutions for spinal conditions, <a
                                    href="{{ route('contact') }}" target="_blank">Contact us</a>
                        ...
                        <p><a href="{{ route('home') }}" target="_blank">Dr. Vishal
