@php($title = 'Case of MIS TLIF – Spinal Fusion by Dr. Vishal Kundnani | Best Spine Specialist in Mumbai')

@section('meta_desc')
    Review a case of MIS TLIF spinal fusion surgery by Dr. Vishal Kundnani, showcasing advanced treatment techniques in
    Mumbai.
@endsection
        ...
        <div class="container">
            <div class="row">
                ...
                <ul class="breadcrumb1">
                    <li><a href="#">Home</a></li>
                    <li><a href="#">Case of MIS TLIF – Spinal Fusion</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        ...
                        <ul>
                            ...
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                ...
                                of slipped
                                bones using implants in spine by one of the best spine surgeon in India – Dr. Vishal
                                Kundnani in
                            ...
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                ...
                                in spine )
                                was performed by Spine specialist in Mumbai- Dr. Vishal Kundnani using small incision and
                                tubular
                            ...
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                ...
                                bed rest
                                post surgery, no blood loss, no infections , no Dural injury , early return to normal life.
                            </li>
                        </ul>
                        ...
                        <p class="mt-2">Tubular Micro endoscopic spine surgery (decompression and spinal fusion) MIS TLIF
                            was done with
                            small incision in spine using tubular retractor and microscope by Dr. Vishal Kundnani at spine
                            clinic Mumbai.
                            Spinal Stenosis with spondylolisthesis surgery done with Minimal invasive spine surgery with
                            transforaminal
                            interbody fusion (MIS TLIF) technique by Dr. Vishal Kundnani using small incision of 2 cm only .
                            Patient got
                            immediate relief and no bed rest required with early return to work.</p>
                        ...
                        <ul>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                ...
                                The
                                spinal implants used for spinal fusion surgery are made of titanium which is an inert metal
                                and extremely
                            ...
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                ...
                                Vishal
                                Kundnani is the pioneer in Spine Navigation surgery in Mumbai. Dr. Vishal Kundnani is the
                                best spine
                                Navigation surgeon in India. Dr. Vishal Kundnani is trained in Navigation spine surgery and
                                robotic spine
                                surgery. Robot in spine surgery makes spine surgery safe. Dr. Vishal Kundnani is the best
                                robotic spine
                                surgeon in Mumbai and best Spine Navigation surgeon in Mumbai for Computer-guided navigation
                                spine
