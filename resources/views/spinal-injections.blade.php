                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <ul>
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Patients with symptoms of Back pain, Leg Pain , Buttock Pain , Numbness in legs due to slip disc or nerve compression or spinal stenosis may be benefitted from spinal injections.</li>
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">The spinal injection for slip disc and spinal stenosis is given by Dr. Vishal Kundnani, one of the best spinal specialist in Mumbai and one of the best spine surgeon in Goregaon, Malad, kandiwali. Available on appointment.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                    <div class="panel-body">
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Spine injections for slip disc or spinal stenosis are of various types</li>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Epidural steroid injections</li>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Facet joint injection</li>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Nerve root Injection</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <ul>
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Epidural Steroid Injection: This is one of the most common injections. It targets the epidural space, which is the space surrounding the membrane that covers the spine and nerve roots. Nerves travel through the epidural space and then branch out to other parts of your body, such as your legs. If a nerve root is compressed (pinched) in the epidural space, you can have pain that travels down your back and into your legs (commonly called sciatica, although the technical medical term is radiculopathy).</li>
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">An epidural steroid injection sends steroids—which are very strong anti-inflammatories—the right to the nerve root that's inflamed. This is a pain management therapy, so it's best to have a well-trained pain management specialist do the injection. You'll probably need 2-3 injections; generally, you shouldn't have more than that because of the potential side effects of the steroids.</li>
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Other Injections: Depending on your diagnosis, doctor may suggest other types of spinal injections. facet joint injection.</li>
                                            </ul>
