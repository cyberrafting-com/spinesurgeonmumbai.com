            ...
            <div class="row">
                <div class="cliclskil1 mt-3">
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        ...
                        <ul>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">तीव्र मागचे/नितंबातील वेदना, पायातील वेदना/सुन्नपणा/झिणझिण्या, चालण्यात अडथळा.</li>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">पायातील संवेदना/शक्ती कमी होणे, प्रोग्रेसिव्ह कमजोरी, शौच/मूत्र नियंत्रण बिघाड.</li>
                        </ul>
                        <h1>स्पाइनल स्टेनोसिससाठी कोणत्या प्रकारच्या सर्जरी होतात?</h1>
                        <p>स्पाइन तज्ञ खालील शस्त्रक्रिया करतात —</p>
                        <ul>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">डी-कंप्रेशन — नसांवरील बाह्य दाब काढणे.</li>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">स्टॅबिलायझेशन — स्पाइनल इम्प्लांट व ग्राफ्टद्वारे वेदनादायक हालचाल रोखणे (फ्युजन).</li>
                        </ul>
                        <h1>स्पाइनल स्टेनोसिससाठी स्पाइन सर्जरी सुरक्षित आहे का?</h1>
                        <ul>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">होय. मायक्रोस्कोपिक/एंडोस्कोपिक मिनिमली इनवेसिव्ह तंत्राने ही सर्जरी सुरक्षित व विश्वासार्ह निकालासह केली जाते.</li>
                        </ul>
                        <h1>शस्त्रक्रियेनंतर पुनर्प्राप्ती कितपत जलद?</h1>
                        <ul>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">स्लिप डिस्क/स्पाइनल स्टेनोसिससाठी मायक्रोस्कोपिक/एंडोस्कोपिक सर्जरीनंतर पुनर्प्राप्ती जलद असते. डिस्चार्जनंतर बेड रेस्टची गरज नसते; सूचनांनुसार काही दिवसांत कामावर परतता येते.</li>
                        </ul>
                        <h1>ओपन सर्जरी व मिनिमल इनवेसिव्ह – कोणती सुरक्षित?</h1>
                        <ul>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">दोन्ही सुरक्षित; मात्र मिनिमल इनवेसिव्हमध्ये लहान कट, कमी वेदना/रक्तस्त्राव/इन्फेक्शन, लवकर डिस्चार्ज व बेड रेस्टची गरज नाही.</li>
                        </ul>
                        <h1>शस्त्रक्रियेनंतर बेड रेस्ट आवश्यक आहे का?</h1>
                        <ul>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">नाही. चालणे व हलके स्ट्रेचिंग सुचवले जाते. कीहोल सर्जरीनंतर लवकरच कामावर जाता येते.</li>
                        </ul>
                        <h1>मुंबईत लंबर स्पाइनल स्टेनोसिससाठी सर्वोत्तम स्पाइन सर्जन कोण?</h1>
                        <ul>
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}" class="wow flipInX animated animated" data-wow-iteration="infinite" alt="pic" style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">डॉ. विशाल कुंदनानी हे लंबर स्पाइनल स्टेनोसिस सर्जरीसाठी सर्वोत्तम स्पाइन सर्जन्सपैकी एक असून मुंबईसह इतर शहरांमध्ये नियुक्तीनुसार उपलब्ध आहेत. ते रुग्णाभिमुख, प्रामाणिक आणि नैतिक स्पाइन प्रॅक्टिस करणारे तज्ञ आहेत.</li>
                        </ul>
