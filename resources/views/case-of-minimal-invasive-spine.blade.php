@php($title = 'Case of Slip Disc by Dr. Vishal Kundnani | Best Spine Specialist in Mumbai')

@section('meta_desc')
    Examine a slip disc case treated by Dr. Vishal Kundnani, Mumbai's top spine specialist. Effective treatment solutions
    showcased.
@endsection
        ...
        <div class="container">
            <div class="row">
                ...
                <ul class="breadcrumb1">
                    ...
                    <li><a href="{{ route('case-of-minimal-invasive-spine') }}">Case Of Minimal Invasive Spine</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        ...
                        <ul>
                            ...
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}"
                                ...
                                DISC
                                WITH L5-S1 HERNIATED DISC was diagnosed as the cause of leg pain and back pain He was
                                advised
                                physiotherapy and medical pain management – gave partial relief by 50 % , however pain
                                recurred every
                                month and affected walking due to leg pain and numbness.</li>
                        </ul>
                        ...
                        <ul>
                            ...
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}"
                                ...
                                Vishal
                                Kundnani is the best spine consultant in Mumbai and is available on appointment in Mumbai on
                                appointment
                            ...
                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}"
                                ...
                                Kundnani using
                                small incision and patient recovered immediately with discharge the very same day and with
                                quick return
                                to work in 3 days with no need of bed rest.</li>
                        </ul>
                        <p class="mt-1">Case example of MRI and surgical pictures of Minimal Invasive spine surgery by
                            best spine speiclaist
                        ...
                        <p class="mt-2">Slip disc surgery done with minimal invasive spine surgery technique by Dr.
                            Vishal Kundnani using
                            small incision of 1.5 cm only. The patient got immediate relief and no bed rest required with
                            early return to
                            work.</p>
                        <h1>Who is the best spine surgeon best spine specialist in Mumbai for treatment of slip disc surgery
                            ?</h1>
                        <p class="mt-2">Dr. Vishal Kundnani is one of the best spine surgeon for slip disc surgery and is
                            available in
                            various hospitals for consultation and for surgery. Dr. Vishal Kundnani is the best spine
                            specialist with
                            considerate approach to patients with honest opinion and ethical spine practice .</p>
                        <p>Dr. Vishal Kundnani is the best microscopic and minimal invasive surgeon for slip disc surgery in
                            Goregaon,
                            Malad, Kandiwali.</p>
                        <h1>Case Study of –</h1>
                        <ul>
