@php($title = 'Spine Surgeon Team Mumbai | Dr. Vishal Kundnani | Spine Clinic Mumbai |')

@section('meta_desc')Meet the spine surgeon team led by Dr. Vishal Kundnani in Mumbai. Expert care and treatment for
spine conditions.@endsection
...
@section('meta_keywords',
    ...
    Mumbai, Spine Surgeon Team Mumbai, Dr. Vishal Kundnani Team, Spine Specialist Team Mumbai, Spine Clinic Mumbai Team,
    Spine Surgery Experts Mumbai, Spine Treatment Team Mumbai, Spine Surgery Specialists, Spine Anaesthesia Team, Spine
    Physiotherapy Team, Best Spine Team Mumbai, Spine Clinic Staff')
    <script type="application/ld+json">
    {
        ...
        "url": "https://spinesurgeonmumbai.com/about-doctor.blade.php",
        "about": {
            "@type": "Person",
            ...
            <div class="row">
                <div class="drtoafndrbs col-lg-8 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <p>Dr. Vishal Kundnani-gold medalist throughout his scholar years - is fellowship trained in spine
                        surgery from international Center's of repute including UK, Singapore, Japan, Australia, Malaysia
                        and Korea. Dr Vishal Kundnani has treated 20000 + Spine patients in last 15 years non surgically
                        with (latest non surgical treatment protocols for slip disc) and performed 5000+ successful
                        Microsurgery for Slip Disc, minimal invasive spine surgery for Sciatica and laser surgery for Lumbar
                        problem & cervical spine and scoliosis. He is Pioneer in complex spine surgery and is best spine
                        specialist for Scoliosis surgery. He is trained in advanced Robotic spine surgery & Navigation spine
                        surgery. Dr Vishal Kundnani is known for innovation in Awake day care spine surgery and minimal
                        invasive spine surgery. He is internationally renowned for scoliosis & Cervical surgery and has more
                        than 100 international scientific research publications. </p>
                    <p>He is national in-charge of fellowship training of young surgeons in india and has trained more than
                        50 fellows who are now working under his mentorship in various cities across country. Dr Vishal
                        kundnani is the best minimal invasive spine surgeon in Mumbai and India and has trained many on this
                        technique across country. </p>
                    <p>Dr Kundnani is avid sportsperson, fitness enthusiast and philanthropist. He is the founder member of
                        social work NGO - Swasthya and Shiksha foundation - providing Subsidised spine healthcare to tribal
                        population in India and promotes education of female child in rural india. </p>
                    <p>Under the aegis of the Swasthya foundation dr kundnani has conducted more than 20 mega super
                        speciality camps in interior tribal areas in central India - MP, Chattisgarh, UP and Bihar -
                        benefitting more than 50000+ underprivileged and needy patients with non surgical care and has
                        performed more than 1500 free spine surgeries bringing smiles and making healthy spines. He has been
                        termed best spine doctor for slip disc in India. </p>
                    <p>He also heads the venture SPINE CLINIC functioning out of four centers in Mumbai and 3 centers out of
                        Mumbai- Bandra, Churchgate, Goregaon, Borivali, Bhopal, Jaipur and Raipur with stringent spine care
                        protocols along with his team providing premium spine care in these cities. Meticulous Safe spine
                        surgery with most recent advanced scientific protocols is the forte of Dr Vishal kundnani who is no
                        doubt the best spine surgeon in mumbai and has been awarded so multiple times.</p>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    editorial Board for Spine Journals and Indian Journal of Orthopedics.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    – Fellow national academy of medical sciences, University of Utah, USA.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <table>
                                                ...
                                                <tr>
                                                    <td>M.S.(Ortho)</td>
                                                    <td>Sawai Man Singh Medical College & Assc. Hospitals, Jaipur
                                                        (Rajasthan)</td>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Sanyam
                                                    Jain, Neil K, Ankit P, Gaurav M, Kundnani V; Efficacy of Posterior
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    Dutta; Kundnani V; Efficacy and feasibility of Trans articular screw-in
                                                    Paediatric (<8 Yrs. ) Atlantoaxial instability; European Spine Journal,
                                                        July 2018.</li>
                                                <li><img src="img/founder_li_icon.png"
                                                        class="wow flipInX animated animated"
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Ruparel
                                                    S, Patel Ankit; Apical Spinal Osteotomy in Severe rigid
                                                    Kyphoscoliosis
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    T, Kundnani V; Comparative evaluation of Radiation dosage, cumulative
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Kundnani
                                                    V, Agashe V, Nene A, Nene A. Multidrug-resistant tuberculosis of the
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Saini,
                                                    Vishal Kundnani, D.S.Meena, P.Patni; Distraction Histogenesis for
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    Vishal Kundnani, Zakir H; Fracture Shaft femur: Close Vs open
                                                    interlocking nailing- Indian Journal of Orthopaedics, Oct 2006/ Vol 40 /
                                                    No. 4.</li>
                                            </ul>
                                        </div>
                                        <p>Getzler Y.D, Kundnani V, Lobkovsky EB, Coates GW; catalytic carbonylation of beta
                                            lactones to succinic anhydrides, Journal Of American Chemistry society Jun 9;
                                            126(22), 2004.</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Kundnani
                                                    Vishal, Uday Pawar, Abhay Nene; Efficacy of CT guided biopsy in spinal
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    Stenosis – CLinical Efficacy of Single stage surgery in Elderly.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Executive
                                                    Committee, Bombay Spine Society, Mumbai.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    of Spine Surgeons conference 2011, 2015.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    research papers in International conferences on more than 25 occasions.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    attended more than 200 conferences on spine surgery and have been a
                                                    member of the organizing the team for more than 25 national and
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    Young Turk Healhtcare Buissness award -2016.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Won
                                                    best Athlete award in Graduation on multiple occasions.</li>
                                            </ul>
                                        </div>
                                        <p>Have led Cricket, Basket Ball & Volley Ball Teams in Graduation & Post
                                            Graduation.</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Bombay
                                                    Orthopedic Society – Life Member.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="cliclskil1">
                                            <ul>
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    Director – Swasthya Foundation – Involved actively in the education of
                                                    girl child in various parts of the country, India and also sponsors free
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}           "
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Founder
                                                    – Director of Mumbai Institute of Spine Surgery-provides spine services
                                                    in medical colleges providing, training, service, and education to the
                                                    postgraduate students which are then selected for the fellowship program
                                                    in various capacities.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
