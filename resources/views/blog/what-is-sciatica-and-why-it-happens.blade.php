...
<script type="application/ld+json">
    {
        ...
        "@graph": [{
                ...
                "url": "https://www.spinesurgeonmumbai.com/what-is-sciatica-and-why-it-happens",
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <div class="blog-profile">
                    ...
                    <p class="bold-text">Dedicated <a href="{{ route('what-is-sciatica-and-why-it-happens') }}">sciatica</a> specialist and spine surgeon in Mumbai.</p>
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                <div class="blog-profile-details">
                    ...
                    <div class="sec-blog-design pt-5">
                        ...
                        <p>Learn more about <a href="{{ route('what-is-a-slipped-disc-herniated-disc') }}">slipped disc treatment</a>.</p>
