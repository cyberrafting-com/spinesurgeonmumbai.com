                    ...
                    <div class="blog-profile-details">
                        ...
                        <div class="row">
                            <div class="sec-blog-design pt-5">
                                ...
                                <p>Back and neck pain are among the most common health problems today.</p>
                                <p>Patients often worry whether their pain is normal, serious, or needs medical care.</p>
                            </div>
                        </div>
                        ...
                        <div class="sec-blog-design pt-5">
                            ...
                            <p>Most cases are not dangerous but should not be ignored if persistent.</p>

                            <p><b>2. What is a Slipped disc (<a href="{{ route('herniated-disc') }}">herniated disc</a>)?</b></p>
                            <p>A slipped disc happens when:</p>
                            <ul>
                                ...
                                <li style="list-style-type: disc; padding: 5px 0;">It causes back pain, leg pain, or numbness</li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li style="list-style-type: disc; padding: 5px 0;">Happens due to nerve compression, usually from a slipped disc</li>
                            </ul>
                            <p>It is a symptom, not a disease.</p>
                            ...
                            <p>You should consult a spine specialist if:</p>
                            <ul>
                            ...
                            <p>Early consultation prevents long-term problems. Consult Dr. Vishal Kundnani at Bombay Hospital or Lilavati Hospital.</p>
                            ...
                            <p>Surgery is needed only if pain or weakness persists.</p>
                            ...
                            <p>Most patients improve without surgery.</p>

                            <p><b>11. When is spine surgery necessary?</b></p>
                            <p>Spine surgery is advised only if:</p>
                            <ul>
                            ...
                            <p>Surgery is the last option, not the first.</p>
                            ...
                            <p><a href="{{ route('minimal-invasive-spine-surgery') }}">Minimally invasive spine surgery</a>:</p>
                            <ul>
                            ...
                            <p>It is effective in selected patients.</p>
                            ...
                            <p><b>19. What causes <a href="{{ route('neck-pain') }}">neck pain</a> and stiffness?</b></p>
                            ...
                            <p>Early treatment prevents chronic neck pain.</p>
                            ...
                            <p>Early diagnosis leads to better outcomes. Consult Dr. Vishal Kundnani, a leading spine specialist in Mumbai, at Bombay Hospital or Lilavati Hospital. <a href="{{ route('contact') }}">Book your consultation</a> today.</p>
                        </div>
