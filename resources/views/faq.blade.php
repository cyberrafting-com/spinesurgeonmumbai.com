@php($title = ' FAQs related to Spine Disease and Treatment | Dr. Vishal Kundnani Spine Specialist Mumbai')

@section('meta_desc')Get answers to frequently asked questions about spine disease and treatment in Mumbai from Dr.
Vishal Kundnani, Mumbai's expert spine specialist. @endsection
...
@section('meta_keywords',
    ...
    Mumbai, Spine Surgery FAQ, Spine Treatment Questions, Back Pain FAQ, Dr. Vishal Kundnani FAQ, Spine Specialist Mumbai
    FAQ, Spine Surgery Recovery, Spine Treatment Cost, Spine Surgery Risks, Spine Surgery Recovery Time, Spine Treatment
    Options')
                        ...
                        <div class="panel-group mt-3" id="accordion" role="tablist" aria-multiselectable="true">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>In between your vertebrae in your spine, you have intervertebral discs. They
                                                help cushion your movements. The disc has a gel-like inner substance called
                                                the nucleus pulposus and a tire-like outer band called the annulus fibrosus.
                                                The nucleus gel-like material can push out through the rupture in the outer
                                                ring annulus: that's called a herniated disc or a slip disc or disc
                                                herniation.</p>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Herniated discs can develop gradually as the result of wear and tear on the
                                                spine-a natural part of aging. As we grow older, our intervertebral discs
                                                can lose their elasticity and water content, making them more likely to
                                                herniate. Over several weeks or even months, the nucleus pulposus can start
                                                to push through the annulus fibrosus. Herniated discs can also happen
                                                suddenly from incorrect lifting or twisting that aggravates a weakened disc.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingThree">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                            ...
                                            What are some non-surgical ways to deal with a Slip disc / HERNIATED DISC /
                                            SCIATICA?
                                        </a>
                                    </h4>
                                </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingFour">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            ...
                                            What are some non-surgical ways to deal with Slip disc / HERNIATED DISC /
                                            SCIATICA?
                                        </a>
                                    </h4>
                                </div>
                                        ...
                                        <div class="cliclskil1">
                                            ...
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}"
                                                    ...
                                                    steroid injection in spine given by spine doctor or spine specialist
                                                    decrease the inflammation of the nerve roots.</li>
                                            </ul>
                                            <p>Treatment options are plenty and shall be planned only in consultation with
                                                the spine specialist doctor.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="cliclskil1">
                                            ...
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}"
                                                    ...
                                                    of sensation/ motor strength/ progressive weakness in legs or loss of
                                                    sensation in the bowel and bladder.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingSix">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            ...
                                            What kinds of surgery are used for Slip disc / Surgery for Herniated disc /
                                        ...
                                        <div class="cliclskil1">
                                            ...
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}"
                                                    ...
                                                    Stabilization: PREVENTION OF PAINFUL MOVEMENT BY SPINAL IMPLANT
                                                    INSERTION AND PUTTING GRAFT FOR FUSION</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingSeven">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            ...
                                            Is Spinal Surgery for Slip Disc / Surgery for Herniated disc / Surgery for disc
                                            bulge Safe?
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            ...
                                            <p>Yes. Spinal surgery for Spinal Stenosis is done with minimal invasive spine
                                                surgery technique using a microscope. Endoscopic Spine surgery for spinal
                                                stenosis and endoscopic spinal surgery for slip disc is extremely safe and
                                                predictable results are obtained.</p>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseEight" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Recovery after Microscopic spine surgery and endoscopic spine surgery for
                                                slip disc and spinal surgery for spinal stenosis is extremely safe and fast.
                                                Patients do not need bed rest after discharge or surgery and can return to
                                                work in a couple of days with instructions.</p>
                                ...
                                <div class="panel-heading" role="tab" id="headingNine">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            ...
                                            Which option is good for safe spine surgery – Open or Minimal Invasive spine
                                            surgery?
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseNine" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            ...
                                            <p>Both surgeries are safe for spinal stenosis and slip disc. Minimal invasive
                                                spine surgery has benefits of small incisions, less pain, less blood loss,
                                                less infections, and early discharge and no bed rest after the surgery are
                                                needed.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingTen">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            ...
                                            Who is the best spine surgeon in Mumbai for Slip disc / Spine specialist for
                                            herniated disc / Spine specialist for sciatica?
                                        </a>
                                    </h4>
                                </div>
                                        ...
                                        <div class="cliclskil1">
                                            ...
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.webp') }}"
                                                        ...
                                                        data-wow-iteration="infinite" alt="pic"
                                                        style="visibility: visible; animation-iteration-count: infinite; animation-name: flipInX;">Dr.
                                                    Vishal Kundnani is one of the best microscopic surgeon / Best Minimal
                                                    Invasive spine surgeon for slip disc surgery in Mumbai.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseEleven" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Open or conventional spine surgery and minimal invasive spine surgery or
                                                keyhole spine surgery. Minimal Invasive spine.</p>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseTwelve" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Surgery is done though a smaller incision without causing access related
                                                problems, yet achieving the same end results, with superior clinical results
                                                and higher safety.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingThirteen">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            ...
                                            What are the advantages of Minimal Invasive spine surgery for slip disc /
                                            microscopic Spine Surgery for slip disc / endoscopic spine surgery for slip disc
                                            / KEY HOLE SURGERY?
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseThirteen" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Minimal invasive spine surgery for slip disc is Extremely safe with benefits
                                                of small incision, less pain, less blood loss, better cosmesis, less
                                                infection rates, less hospital stay, early return to work and no long term
                                                back pain problems.</p>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseFourteen" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Yes, it's a very simple and safe surgery for SLIP DISC or SCIATICA and the
                                                patient can be discharged on the same day of surgery.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseFifteen" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Yes, Spinal surgery for slip disc is 100% safe, Surgery is the permanent
                                                solution for some patients with severe leg pain.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseSixteen" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>The loose fragment of the SLIP DISC, compressing on a nerve root, is removed
                                                through a very small hole with microscope/endoscope with no side effects and
                                                bed rest required after surgery.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseSeventeen" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>KEYHOLE SURGERY, minimal invasive spine surgery, Microscopic spine surgery,
                                                Minimal invasive spine surgery is safely done for SLIP DISC*/SCIATICA,
                                                SPINAL STENOSIS**, SPONDYLOLISTHESIS ***, SPONDYLOLYSIS****, Spine Fracture
                                                are some other cases routinely performed with keyhole spine surgery.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseEighteen" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Yes, in fact, the real advantage is in elderly people with lesser blood loss
                                                and less pain in KEYHOLE SURGERY.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingNinteen">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseNinteen" aria-expanded="false"
                                            aria-controls="collapseNinteen">
                                            How many days of hospital stay is required for KEY HOLE SURGERY?
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseNinteen" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="headingNinteen">
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Usually, patients can be discharged within 24- 48 hours after surgery and
                                                there is no restriction in most of the cases after surgery. Patients can
                                                resume work within a week of surgery.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseTwenty" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>Dr. Vishal Kundnani is the best spine surgeon for slip disc surgery and is
                                                available in various hospitals for consultation and for surgery. Dr. Vishal
                                                Kundnani is the best spine specialist with a considerate approach to
                                                patients with an honest opinion and ethical spine practice.</p>
                                            <p>Dr. Vishal Kundnani is the best microscopic surgeon for slip disc surgery.
                                                Dr. Vishal Kundnani is the best endoscopic spine surgeon in Mumbai for
                                                spinal stenosis and slip disc surgery and has performed more than 5000 spine
                                                surgeries with minimal invasive spine surgery technique.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div id="collapseTwentyone" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>General precautions for 3-6 weeks. Avoid ground level activities, like
                                                squatting, bending, sudden jerks, heavy lifting, etc.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingTwentytwo">
                                    <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                            data-parent="#accordion" href="#collapseTwentytwo" aria-expanded="false"
                                            aria-controls="collapseTwentytwo">
                                            Is BED REST after spinal surgery / spine surgery required?
                                        </a>
                                    </h4>
                                </div>
                                <div id="collapseTwentytwo" class="panel-collapse collapse" role="tabpanel"
                                    aria-labelledby="headingTwentytwo">
                                    <div class="panel-body">
                                        <div class="cliclskil1">
                                            <p>NO. After surgery patient should walk routinely and do some stretching
                                                exercises. After KEYHOLE SURGERY, no bed rest is required and one can resume
                                                work soon.</p>
                                        </div>
                                    </div>
                                </div>
