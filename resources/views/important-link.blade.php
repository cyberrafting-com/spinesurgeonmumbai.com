...
@section('meta_desc')Get effective treatment for kyphosis from Dr. Vishal Kundnani Spine Specialist in Mumbai. Expert care and solutions in Mumbai for spine health. @endsection
        ...
        <div class="container">
            <div class="row">
                ...
                <ul class="breadcrumb1">
                    <li><a href="{{ url('/') }}">Dr.</a></li>
                    <li><a href="{{ url('/slip-disc') }}">Vishal Kundnani</a></li>
                </ul>
            </div>
        </div>
    </div>
