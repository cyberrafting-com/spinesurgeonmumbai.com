@php($title = 'Spondylolisthesis: Spine Surgery Treatment in Mumbai')

@section('meta_desc')Explore spine surgery options for spondylolisthesis with Dr. Vishal Kundnani Spine Surgeon in
Mumbai. Expert treatment in Mumbai for spine health.@endsection
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="cliclskil1">
                                        <ul>
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                narrow due to forward slip of one bone of spine over other . This slip
                                                of Spondylolisthesis leads to narrowing of channels where spinal cord
                                ...
                                <div class="panel-body">
                                    <ul>
                                        ...
                                        <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                            ...
                                            standing or during the walk for a smaller distance. In severe cases of
                                            Spondylolisthesis, nerves to the bladder or bowel may be compressed, which
                                            can lead to partial or complete incontinence. The earliest symptom of this
                                            may be increased frequency of urination or urgency of urination and may
                                            progress to complete incontinence/inability to control urine. This is a
                                            surgical emergency and may need surgery at earliest.</li>
                                    </ul>
                                    <p>Dr. Vishal Kundnani is the best spinal surgeon who performs minimally invasive
                                        spinal surgery for spinal stenosis. Dr. Vishal Kundnani is the best spinal
                                        specialist in India for spinal stenosis surgery and performs the surgery with
                                        minimally invasive spine surgery technique.</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                                    ...
                                    <div class="cliclskil1">
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                like X-Ray and MRI SCAN OR CT SCAN to diagnose in the presence of
                                                symptoms. MRI scan can show various grades of Spondylolisthesisand may
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                exercises, medication and injection in spine. Meet your spine specialist
                                                to decide on which is the best treatment option for you. To treat
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                Clinic Mumbai –best spine clinic in Mumbai for treatment of slip disc.
                                                Dr. Vishal Kundnani is one of the best spine consultants in Mumbai and
                                                is available on appointment in Mumbai on appointment for spine
                                                specialist.</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseSix" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        <p>Surgery is required in a select group of patients with severe symptoms
                                            affecting daily living. Nonsurgical treatment helps in most patients
                                            significantly.</p>
                                        <p>The non-surgical treatment option is decided based on the duration and
                                        ...
                                        <p>Dr. Vishal Kundnani is one of the best spinal specialist in mumbai managing
                                            spinal stenosis and Spondylolisthesis and is one of the best minimal
                                            invasive spinal surgeon in india for Spondylolisthesis surgery.</p>
                                        <p>These options of non-surgical management of Spondylolisthesis are available
                                            at Spine Clinic Mumbai – one of the best spine clinics in Mumbai for
                                            treatment of Spondylolisthesis. Dr. Vishal Kundnani is one o the best spine
                                            consultant in Mumbai and is available on appointment in Mumbai on
                                            appointment for spine specialist. Dr. Vishal Kundnani is one of the best
                                            spines Specialist in Mumbai and best spinal consultation Goregaon, Kandiwali
                                            and Malad.</p>
                            ...
                            <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        ...
                                        <p>Surgery for Spondylolisthesis involves decompression and fusion – freeing the
                                            nerves of the compression from disc or facet joints in spine and to
                                        ...
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                <br>Decompression: Tissue pressing against a nerve structure is trimmed
                                                , which makes more room in the spinal canal (for the spinal cord) or in
                                                the foramen (for the nerve roots).
                                                <br>Stabilization: to limit motion between vertebrae when instability is
                                                the cause of problem giving rise to pain and numbness / weakness.
                                            </li>
                                        </ul>
                                        <p>Various options of spine surgery include conventional open spine surgery and
                                            minimally invasive spine surgery or MIS surgery for spondylolisthesis. These
                                            options of surgical management of Spondylolisthesis are available at Spine
                                            Clinic Mumbai – Best Spine Clinic in Mumbai for treatment of slip disc and
                                            spinal stenosis. Dr. Vishal Kundnani is one of the best spine consultants in
                                            Mumbai and is available on appointment in Mumbai. Dr. Vishal Kundnani is one
                                            of the best spine specialist in Mumbai and best spinal minimal invasive
                                            spine surgeon in Goregaon, Kandivali and Malad.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                root in its path (an exit called the foramen), a foraminotomy – widening
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                relieved by spreading the bones apart instead of removing the bone. This
                                                can be done with different techniques and various instrumentation some
                                                examples are distraction laminoplasty with or without implants like
                                                interspinous process devices or interbody cages. Even artificial discs
                                                can accomplish some indirect decompression by restoring the height
                                                between adjacent vertebrae.</li>
                                        </ul>
                                        <p>Various options of spine surgery include conventional open spine surgery and
                                            minimally invasive spine surgery or MIS surgery for spinal stenosis. These
                                            options of surgical management of slip disc and spinal stenosis are
                                            available at Spine Clinic Mumbai – Best Spine Clinic in Mumbai for treatment
                                            of slip disc and spinal stenosis. Dr. Vishal Kundnani is the best spine
                                            consultant in Mumbai and is available on appointment in Mumbai on
                                            appointment for spine specialist. Dr. Vishal Kundnani is the best spine
                                            specialist in Mumbai and best spinal consultantinGoregaon, Kandivali and
                                            Malad.</p>
                                    ...
                                    <div class="cliclskil1">
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                surgeons for the unstable and painful spine to reduce pain. The
                                                instability in the spine can be due to various reasons. The simplest and
                                                most common reason of instability in the spine is SPONDYLOLISTHESIS
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                movement at the unstable spinal bones. This is achieved by inserting
                                                implants in the spine after a dedicated and thorough discectomy. The
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                tuberculosis, spinal stenosis, spinal trauma, and spinal tumors. Spinal
                                                fusion is performed for adjacent segment disease in the lumbar spine or
                                                thoracic spine.</li>
                                        </ul>
                                        <p>Various options of Spinal Fusion surgery include conventional open spine
                                            surgery and minimally invasive spine surgery or MIS surgery for spinal
                                            fusion. These options of surgical management of spinal fusion are available
                                            at Spine Clinic Mumbai – Best Spine Clinic in Mumbai for treatment of Spinal
                                            Fusion. Dr. Vishal Kundnani is one of the Best Spine Consultant in Mumbai
                                            and is available on appointment in Mumbai. Dr. Vishal Kundnani is the best
                                            spine specialist in Mumbai and one of the best spinal surgeon in Goregaon,
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                dedicated discectomy between the bones in the spine . The surgeon
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                and plates and cages ) in the spine after decompression surgery. The
                                                spinal implants are an extremely safe procedure. It is an extremely safe
                                                procedure.</li>
                                        </ul>
                                        <div class="col-lg-5">
                                        ...
                                        <p>Dr. Vishal Kundnani – one of the Best Spine Surgeon in Mumbai, frequently
                                            ...
                                            in Mumbai and one of the best minimal-invasive spine surgeon in Goregaon,
                                            Kandivali and Malad.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseEleven" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        <p>Spinal fusion can be done in open conventional technique or Spinal Fusion is
                                            done with Minimal invasive technique. Minimal invasive spinal fusion surgery
                                            is extremely safe and simple and most efficient. The best technique to do
                                            spinal fusion is Minimal Invasive Spinal Fusion. Minimal invasive spinal
                                            fusion also called as minimal invasive transforaminal interbody fusion or
                                            MIS-TLIF or MIS TLIF is a extremely safe procedure with plenty of benefits
                                            of less pain , less blood loss, less infection, smaller incisions, early
                                            return to work, early discharge from hospital, no need of bed rest after
                                            surgery.</p>
                                    ...
                                    <div class="cliclskil1">
                                        <ul>
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                efficient. The best technique to do spinal fusion is Minimal Invasive
                                                Spinal Fusion. Minimal invasive spinal fusion also called as minimal
                                                invasive transforaminal interbody fusion or MIS-TLIF or MIS TLIF is a
                                                extremely safe procedure with plenty of benefits of small incisions
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                performed by Dr. Vishal Kundnani – one of the Best Spine Surgeon in
                                                Mumbai. Best spinal surgeon in Mumbai to perform spinal fusion surgery
                                                is Dr. Vishal Kundnani. Dr. Vishal Kundnani is one of the best spine
                                                specialists in Mumbai and one of the best minimal-invasive spine surgeon
                                                in Goregaon, Kandivali and Malad.</li>
                                        </ul>
                            ...
                            <div class="panel-heading" role="tab" id="headingThirteen">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                        ...
                                        Is spinal implant inserted by Minimal invasive spine surgery safe? Is screw
                                        plate in spine inserted by MIS safe? Is screw plate FUSION surgery safe?
                                    </a>
                                </h4>
                            </div>
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                which is an inert, metal and extremely safe for the human body. When
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                and navigation and robotics in spine surgery to make sure surgery is
                                                safe for patients.</li>
                                        </ul>
                                        <p>Dr. Vishal Kundnani is the pioneer in Spine Navigation surgery in Mumbai. Dr.
                                            Vishal Kundnani is the best spine Navigation surgeon in India. Dr. Vishal
                                            Kundnani is trained in Navigation spine surgery and robotic spine surgery.
                                            Robot in spine surgery makes spine surgery safe. Dr. Vishal Kundnani is the
                                            best robotic spine surgeon in Mumbai and best Spine Navigation surgeon in
                                            Mumbai for Computer-guided navigation spine surgery in Mumbai.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                Talk to your doctor about how to start an exercise program that is right
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                the treatment plan your doctor has outlined. Make sure you have regular
                                                check-ups, and tell your doctor if you are not getting better.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFifteen" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        <p>Minimal invasive spine surgery leads to fast recovery and makes patient
                                            walking after surgery within 24 hours. In fact in minimally invasive surgery
                                            and microendoscopic surgery and minimally invasive spinal fusion results in
                                            early return to work without any need of bed rest after surgery.</p>
                                        <p>After surgery, the patient is mobilized out of bed within 24 hours, and pain
                                            medications are continued for 5 days. After the surgery, general do's and
                                            don'ts instructions are given about. With Minimal, Invasive spine surgery
                                        ...
                                        <p>Dr. Vishal Kundnani is one of the best minimal invasive spine surgeon for
                                            spinal fusion surgery and best microscopic / best Endoscopic Spine Surgeon
                                            in mumbai for spinal stenosis surgery.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
