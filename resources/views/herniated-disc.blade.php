@php($title = 'Top Treatment for Herniated Disc in Mumbai by Dr. Vishal Kundnani')

@section('meta_desc')Find top treatment options for herniated disc with Dr. Vishal Kundnani, Mumbai's leading spine
specialist. Effective care for relief.@endsection
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                                        ...
                                        How does our spine look like ? What is Anatomy of Disc Herniation / Herniated
                                        disc/ Slip disc /Sciatica / Bulge Disc ?
                                    </a>
                                </h4>
                            </div>
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                consists of 33 vertebrae (bones). There are cushion-like structures
                                                called discs between each of the vertebra that act as shock absorbers
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                canal) to house the spinal cord and spinal nerves. These nerves run down
                                                the center of the vertebrae and exit to various parts of the body. When
                                                the disc or cushion slips into the spinal canal causing compression of
                                                the nerve then its called Slip Disc OR HERNIATED DISC or Spinal
                                                Stenosis. Compression of nerve results in Back Pain OR Buttock pain or
                                                LEG PAIN OR back pain traveling down the leg and patients complains of
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <div class="cliclskil1">
                                    <p>When the disc or cushion slips into the spinal canal causing compression of the
                                        nerve then its called Slip Disc OR HERNIATED DISC or Spinal Stenosis.
                                        Compression of nerve results in Back Pain OR Buttock pain or LEG PAIN OR back
                                        pain traveling down the leg and patients complains of pain in leg with numbness
                                        and difficulty in walking. this pain is also called Sciatica.</p>
                                ...
                                <div class="panel-body">
                                    <ul>
                                        ...
                                        <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                            ...
                                            professionally trained spine specialists headed by Dr. Vishal Kundnani –
                                            Best Spine Specialist in Mumbai.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="cliclskil1">
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                term used to describe the leak of soft disc gel-like material from
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                the spine. This wear and tear process is called Degeneration and is
                                                related to daily activities over a period including poor posture and
                                                weak muscles. Slip Disc can also be linked to the injury and trauma to
                                                spine sudden jerk or weight lifting or bending. Slip Disc/ Herniation of
                                                a disc can occur slowly over time, taking weeks or months or pain may
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                complaints in all patients. The symptoms include include dull or sharp
                                                pain in back , Low Back Pain , Back Pain , muscle spasm, Locked back ,
                                                stiffness in back , Morning stiffness , Leg pain , Numbness in calf or,
                                                Pain in back travelling down to legs with numbness and weakness,
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                called cauda equina syndrome and rarely can cause paralysis – weakness
                                                of one or both lower limbs. The weakness of foot due to nerve
                                                compression is called foot drop and needs surgery at earliest for
                                                recovery. These conditions are called surgical emergency as surgery is
                                                advisable in emergent situations like this for optimal recovery.</li>
                                        </ul>
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                investigations like x-ray and MRI scan to diagnose the presence of Slip
                                                Disc in the presence of symptoms. MRI can show various grades of Slip
                                                Disc and may also suggest if surgery is really needed in view of ongoing
                                                compression of nerves in the spinal canal.</li>
                                        </ul>
                                        <p class="mt-3">Dr. Vishal Kundnani is specialized in the management of Slip
                                            Disc and herniated disc. Dr. Vishal Kundnani is the best spine surgeon in
                                            Mumbai and is available at SPINE CLINIC on Appointment in various locations
                                            in Mumbai on appointment. Dr. Vishal Kundnani is the best spine consultant
                                            in Mumbai and is available on appointment in Mumbai on appointment for spine
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        <p>No most of the patients with Slip disc / Disc herniation get better with
                                            nonsurgical methods, However one should seek medical attention in
                                            consultation with spinal surgeon/spine surgeon /spine specialist. Dr. Vishal
                                        ...
                                        <ul>
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                pain/Leg or arm pain, weakness, numbness, tingling/Loss of feeling or
                                                weakness in your bladder or anus/Loss of bowel or bladder control.</li>
                                        </ul>
                                        <p>Nonsurgical treatment options to treat slip disc include physiotherapy,
                                            exercises, medication and injection in spine. Meet your spine specialist to
                                            decide on which is the best treatment option for you. The best spine
                                            specialist in India is Dr. Vishal Kundnani, Mumbai who manages these
                                            problems with a scientific approach.</p>
                                        <p>These options of non-surgical management of slip disc are available at Spine
                                            ...
                                            Kundnani is the best spine specialist in Mumbai and best spinal consultation
                                            Goregaon, Kandiwali and Malad.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="collapseEight" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        <p>Normally the type of non-surgical treatment is decided based on the duration
                                        ...
                                        <p>However before one resorts to any option one should have advise of spine
                                            specialist.</p>
                                        <p>These options of non-surgical management of slip disc are available at Spine
                                            Clinic Mumbai –best spine clinic in Mumbai for treatment of Slip Disc. Dr.
                                            Vishal Kundnani is the best spine consultant in Mumbai and is available on
                                            appointment in Mumbai on appointment for spine specialist. Dr. Vishal
                                            Kundnani is the best spine specialist in Mumbai and best spinal consultation
                                            Goregaon, Kandivali and Malad.</p>
                                    ...
                                    <div class="cliclskil1">
                                        <ul>
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                how to condition your body to prevent further injury and help in the
                                                recovery of a painful episode. Physiotherapy shall be taken in the
                                                supervision and guidance of spine specialist.</li>
                                        </ul>
                                        <p>Dr. Vishal Kundnani is the best Spine Specialist for Slip Disc in Mumbai and
                                            is available on appointment in Mumbai on appointment for spine specialist.
                                            Dr. Vishal Kundnani is the best spine Minimal invasive spine specialist in
                                            Mumbai and best Minimal Invasive spinal Surgeon in Goregaon, Malad and
                                            Kandivali.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="collapseTen" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        ...
                                        <p>Physiotherapy has a major role in spinal slip disc treatment. It teaches how
                                            to condition your body to prevent further injury and help in the recovery of
                                            the painful episode. There are a variety of physical therapy techniques.
                                        ...
                                        <p><b>Passive Treatments:</b>
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    your body's natural pain killers. TENS machine stimulates your
                                                    muscles through variable (but safe) intensities of electrical
                                            ...
                                            <ul>
                                                ...
                                                <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}"
                                                    ...
                                                    strengthening: Strong muscles are a great support system for your
                                                    spine and better handle pain and strengthening of muscles which can
                                                    cause your back stretches and strengthening along with pelvic tilt,
                                                    which helps you find a neutral spine position</li>
                                            </ul>
                                            <p>Dr. Vishal Kundnani is the best spine surgeon for slip disc surgery and
                                            ...
                                            <p>These options of nonsurgical management of slip disc are available at
                                                Spine Clinic Mumbai –best spine clinic in Mumbai for treatment of slip
                                                disc. Dr. Vishal Kundnani is the best spine consultant in Mumbai and is
                                                available on appointment in Mumbai on appointment for spine specialist.
                                                Dr. Vishal Kundnani is the best spine specialist in Mumbai and best
                                                spinal consultation Goregaon, Kandivali and Malad</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="collapseEleven" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        <p>Most patients with slip disc respond well to non-surgical treatments (such as
                                    ...
                                    <div class="cliclskil1">
                                        ...
                                        <ul>
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                with Slip Disc / herniated disc. Slip disc surgery performed with small
                                                incisions and with endoscope and microscope is the best way to perform
                                                disc surgery. This results in less pain, no blood loss, no need for bed
                                                rest after surgery. This is also called microendoscopic discectomy –
                                                Micro endoscopic Discectomy.</li>
                                        </ul>
                                        <p>Various options of spine surgery include conventional open spine surgery and
                                            minimally invasive spine surgery or MIS surgery for Slip Disc / Herniated
                                            disc. These options of surgical management of slip disc and spinal stenosis
                                            are available at Spine Clinic Mumbai – Best Spine Clinic in Mumbai for
                                            treatment of Slip Disc and spinal stenosis.</p>
                                        <p>Dr. Vishal Kundnani is the best spine consultant in Mumbai and is available
                                            on appointment in Mumbai on appointment for spine specialist. Dr. Vishal
                                            Kundnani is the best spine Minimal invasive spine specialist in Mumbai and
                                            best Minimal Invasive spinal Surgeon in Goregaon, Malad and Kandivali</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="cliclskil1">
                                        <ul>
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                medications are continued for 5 days. After the surgery, general do's
                                        ...
                                        <p>Dr. Vishal Kundnani is the best spine consultant in Mumbai and is available
                                            on appointment in Mumbai on appointment for spine specialist.Dr. Vishal
                                            Kundnani is the best spine Minimal invasive spine specialist in Mumbai and
                                            best Minimal Invasive spinal Surgeon in Goregaon, Malad and Kandiwali.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="cliclskil1">
                                        <ul>
                                            ...
                                            <li><img src="{{ asset('resources/assets/img/founder_li_icon.png') }}" class="wow flipInX animated animated"
                                                ...
                                                nearby locality. Dr. Vishal Kundnani is the best spine specialist in
                                                Goregaon, Mumbai</li>
                                        </ul>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingSixteen">
                                <h4 class="panel-title">
                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                        ...
                                        Who is the best spine surgeon best spine specialist in Mumbai for treatment of
                                        slip disc surgery?
                                    </a>
                                </h4>
                            </div>
                            <div id="collapseSixteen" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <div class="cliclskil1">
                                        <p>Dr. Vishal Kundnani is one of the best Spine Surgeons for slip disc surgery
                                            and is available in various hospitals for consultation and for surgery. Dr.
                                            Vishal Kundnani is the best spine specialist with a considerate approach to
                                            patients with an honest opinion and ethical spine practice.</p>
                                        <p>Dr. Vishal Kundnani is the best microscopic and minimally invasive surgeon
                                            for slip disc surgery in Goregaon, Malad, Kandivali.</p>
