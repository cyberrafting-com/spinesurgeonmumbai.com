                ...
                <div class="col-lg-9 col-md-8 col-sm-12">
                    <div class="blog-profile-details">
                        ...
                        <div class="sec-blog-design pt-5">
                            ...
                            <p><a href="scoliosis.php">Scoliosis</a> is a condition in which the spine curves sideways, often forming an "S" or "C" shape. This condition can affect people of all ages, from children to adults. Early detection is crucial in preventing the condition from worsening. While mild cases might go unnoticed, more pronounced curvatures can cause visible deformities and lead to physical symptoms, including discomfort and movement difficulties.<br>
                        ...
                        <div class="sec-blog-design pt-5">
                            ...
                            <div class="cat-service-inner pt-5">
                                <img src="img/founder_li_icon.png" alt="">
                                <p><a href="back-pain.php">Back pain</a> or discomfort, especially after physical activity</p>
                            </div>
                        ...
                        <div class="sec-blog-design pt-5">
                            ...
                            <p>At our <a href="about-mumbai-institute-of-spine-surgery.php">Mumbai Institute of Spine Surgery (M.I.S.S)</a>, we use advanced diagnostic techniques to ensure accurate assessment of scoliosis cases.</p>
                        </div>
                        ...
                        <div class="sec-blog-design pt-5">
                            ...
                            <div class="cat-service-inner pt-5">
                                <img src="img/founder_li_icon.png" alt="">
                                <p><strong>Observation and Exercises:</strong> For mild scoliosis, doctors may recommend regular monitoring and exercises that help improve posture and strengthen the muscles supporting the spine. <a href="physiotherapy-in-spine.php">Physical therapy</a> can also help with flexibility and reduce pain.</p>
                            </div>
                            ...
                            <div class="cat-service-inner pt-5">
                                <img src="img/founder_li_icon.png" alt="">
                                <p><strong>Surgical Intervention:</strong> In more severe cases, or if the curve is progressing, surgery may be necessary to correct the spine's curvature. Traditional open surgery can be used, but modern advancements have led to the development of <a href="minimal-invasive-spine-surgery.php">minimally invasive scoliosis surgery</a>, which is less traumatic and offers a quicker recovery time.</p>
                            </div>
                            
                            <div class="cat-service-inner pt-5">
                                <img src="img/founder_li_icon.png" alt="">
                                <p><strong>Minimally Invasive Surgery:</strong> <a href="micro-endoscopic-minimal-invasive-spine-surgery.php">Minimally invasive surgery</a> uses smaller incisions and advanced imaging technology to correct the spinal curve with greater precision. This technique offers several benefits over traditional surgery, including:</p>
                            </div>
                        ...
                        <div class="sec-blog-design pt-5">
                            ...
                            <p>Our <a href="about-centre-of-excellence-in-spine-surgery.php">Centre of Excellence in Spine Surgery (C.E.S.S)</a> provides comprehensive care for all spine-related conditions including scoliosis.</p>
                        </div>
                        ...
                        <div class="sec-blog-design pt-5">
                            ...
                            <p>Visit our <a href="contact.php">contact page</a> for more information or to schedule an appointment. You can also explore our <a href="testimonials.php">patient testimonials</a> and <a href="case-of-minimal-invasive-spine.php">case studies</a> to learn about successful scoliosis treatments.</p>
                        </div>
                    </div>
                </div>
            </div>
